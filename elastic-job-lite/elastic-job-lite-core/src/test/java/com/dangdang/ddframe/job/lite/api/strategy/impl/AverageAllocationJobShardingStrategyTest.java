...
public final class AverageAllocationJobShardingStrategyTest {
    ...
    public void shardingForZeroServer() {
        assertThat(jobShardingStrategy.sharding(Collections.<JobInstance>emptyList(), jobNames,"test_job", 3), is(Collections.<JobInstance, List<Integer>>emptyMap()));
    }
    ...
    public void shardingForOneServer() {
        ...
        assertThat(jobShardingStrategy.sharding(Collections.singletonList(new JobInstance("host0@-@0")), jobNames,"test_job", 3), is(expected));
    }
    ...
    public void shardingForServersMoreThanShardingCount() {
        ...
        assertThat(jobShardingStrategy.sharding(Arrays.asList(new JobInstance("host0@-@0"), new JobInstance("host1@-@0"), new JobInstance("host2@-@0")), jobNames,"test_job", 2), is(expected));
    }
    ...
    public void shardingForServersLessThanShardingCountAliquot() {
        ...
        assertThat(jobShardingStrategy.sharding(Arrays.asList(new JobInstance("host0@-@0"), new JobInstance("host1@-@0"), new JobInstance("host2@-@0")), jobNames,"test_job", 9), is(expected));
    }
    ...
    public void shardingForServersLessThanShardingCountAliquantFor8ShardingCountAnd3Servers() {
        ...
        assertThat(jobShardingStrategy.sharding(Arrays.asList(new JobInstance("host0@-@0"), new JobInstance("host1@-@0"), new JobInstance("host2@-@0")), jobNames,"test_job", 8), is(expected));
    }
    ...
    public void shardingForServersLessThanShardingCountAliquantFor10ShardingCountAnd3Servers() {
        ...
        expected.put(new JobInstance("host1@-@0"), Arrays.asList(3, 4, 5));
        expected.put(new JobInstance("host2@-@0"), Arrays.asList(6, 7, 8));
        assertThat(jobShardingStrategy.sharding(Arrays.asList(new JobInstance("host0@-@0"), new JobInstance("host1@-@0"), new JobInstance("host2@-@0")), jobNames,"test_job", 10), is(expected));
    }
}
